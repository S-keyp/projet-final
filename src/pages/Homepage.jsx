		...
		<div className="homepage">
			<header className="header">
				<h1 className="header__title">
					...
					<span className="word">
						<span className="letter">B</span>istro
					</span>
